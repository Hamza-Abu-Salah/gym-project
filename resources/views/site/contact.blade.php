                    ...
                    <div class="col-lg-12 text-center">
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item"><a href="#"
                                    class="text-color text-uppercase text-sm letter-spacing">contact</a></li>
                        </ul>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <div class="section-title">
                            ...
                            <h2>Contact Us</h2>
                            <p class="mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. In error
                                reprehenderit
                ...
                <div class="row justify-content-center pb-5">
                    ...
                    <div class="col-lg-9 text-center">
                        <form id="contact-form" action="{{ route('site.contact_date') }}" method="POST">
                            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                        <div class="card rounded-0 border-0 shadow-sm text-center py-5 px-4 contact-info">
                            ...
                            <span>Call us</span>
                            <p class="lead text-black mb-0 mt-3">{{ $setting->phone }}</p>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                        <div class="card rounded-0 border-0 shadow-sm text-center py-5 px-4 contact-info">
                            ...
                            @foreach (\App\Models\User::get() as $user )
                                <p class="lead text-black mt-3 mb-0">{{ $user->email }}</p>
                            @endforeach
                            <p class="lead text-black ">{{ $setting->email }}</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                        <div class="card rounded-0 border-0 shadow-sm text-center py-5 px-4 contact-info">
                            ...
                            <span>Location</span>
                            <p class="lead text-black mt-3">{{ $setting->location }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>
